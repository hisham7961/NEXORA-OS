...
| 6 | My Day | 🟡 | مهام + فحوصات + موافقات + مواعيد + حضور ضمن النطاق. *يومي 2.0 (إشارات + حالات/طلبات تصميم مُسندة + نشر مستحق + مواعيد تسجيل + نقاشات غير مقروءة) في الطور 2.5 §21.* |
...
| 22 | Employee Attendance | ✅ | ساعة حضور بآلة حالة مُتحقَّقة check-in/break/back/check-out + مدد محسوبة (Part S). *حلقة طلب/اعتماد التصحيح في الطور 2.5 §25.* بلا مراقبة تجسسية (مطابق). |
